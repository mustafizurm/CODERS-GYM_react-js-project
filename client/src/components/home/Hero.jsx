...
const Hero = () => {
  return (
    <section className='hero_Section'>
      <div className='w-[96%] sm:max-w-[620px] md:max-w-[760px] lg:max-w-[1010px] xl:max-w-[1260px] m-auto grid grid-cols-1 md:grid-cols-2 items-center gap-[90px] py-[100px]'>
